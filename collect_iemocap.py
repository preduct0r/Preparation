...
#     prepared_base_path = r'D:\iemocap_audio_only\{}'.format(base_meta_yaml['base_name'])
...
#     path_to_base = r'D:\iemocap_audio_only\IEMOCAP_full_release'
#     file_id = 0
#     labels_counter = {}
#
...
#             if not fnmatch(f_name, '*impro??.txt'):
#                 continue
